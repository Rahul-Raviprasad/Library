(function () {
  ...
  xdescribe('Articles List Controller Tests', function () {
    ...
    describe('Instantiate', function () {
      ...
      it('should send a GET request and return all articles', inject(function (BooksService) {
        // Set POST response
